    ...
    <div className="container-homepage">
      ...
      <div className="container-games">
        <div className="game-card">
          ...
          <Link to="/leap-birthyear" className="link-game">Leap Birthyear</Link>
        </div>
        <div className="game-card">
          <Link to="/prime-birthday" className="link-game">Prime Birthday</Link>
        </div>
        <div className="game-card">
          <Link to="/lucky-birthday" className="link-game">Lucky Birthday</Link>
        </div>
        <div className="game-card">
          <Link to="/pallindrom-birthday" className="link-game">Pallindrome Birthday</Link>
        </div>
      </div>
